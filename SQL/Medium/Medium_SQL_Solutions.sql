...
/*
_____________________________________________________________________________________________________________
16) Problem: Second Highest Salary
LeetCode: https://leetcode.com/problems/second-highest-salary/description/?envType=study-plan-v2&envId=top-sql-50
...
/*
_____________________________________________________________________________________________________________
16) Problem: Tree Node
LeetCode: https://leetcode.com/problems/tree-node/description/?envType=problem-list-v2&envId=db-db3-grouping-aggregation
...
/*
_____________________________________________________________________________________________________________
17) Problem: Rank Scores
LeetCode: https://leetcode.com/problems/rank-scores/?envType=problem-list-v2&envId=db-db4-window-functions-ranking
...
Approach 1:
1) Use DENSE_RANK() to assign a rank to each score.
2) Use ORDER BY to sort the result table by score in descending order.
*/
